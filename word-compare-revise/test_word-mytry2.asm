.data
	...
	filename: .asciiz "test-dict.txt" #file 
...
loop:
	...
	beq	$t3, 32,spaceFound	#  go to nullfound to check state of 2nd string
...
spaceFound:
	beq	$t2, 10,found	# if 2nd string index is also \0, success
	addi    $a1,$t1,1
	j	compareStrings
